...
// Current-year sources and historical approximations: docs/tax-methodology.md
export const taxYears: TaxYearsData = {
  '2026/27': {
    childBenefitRates: {
      firstChildRate: 27.05,
      additionalChildRate: 17.9,
    },
  ...
  '2023/24': {
    ...
    nationalInsurance: {
      ...
      upperEarningsLimit: 50270,
      employerRates: [0.138, 0.138],
      employeeRates: [0.115, 0.02], // 9 months at 12%, 3 months at 10%; even-pay estimate
    },
    selfEmployedNI: {
      class2WeeklyRate: 3.45,
      class2SmallProfitsThreshold: 12570,
      class4LowerLimit: 12570,
      class4UpperLimit: 50270,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
      defaultRate: 0.09,
      postgradRate: 0.06,
  ...
  '2022/23': {
    ...
    selfEmployedNI: {
      ...
      class2SmallProfitsThreshold: 11908,
      class4LowerLimit: 11908,
      class4UpperLimit: 50270,
      class4Rates: [0.0973, 0.0273],
    },
    studentLoan: {
      defaultRate: 0.09,
      postgradRate: 0.06,
  ...
  '2021/22': {
    ...
    selfEmployedNI: {
      class2WeeklyRate: 3.05,
      class2SmallProfitsThreshold: 6515,
      class4LowerLimit: 9568,
      class4UpperLimit: 50270,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
  ...
  '2020/21': {
    ...
    hicbc: { threshold: 50000, taperDivisor: 100 },
    qualifyingEarnings: { lower: 6240, upper: 50000 },
    pensionAnnualAllowance: {
      standard: 40000,
      taperThresholdIncome: 200000,
      taperAdjustedIncome: 240000,
    ...
    selfEmployedNI: {
      class2WeeklyRate: 3.05,
      class2SmallProfitsThreshold: 6475,
      class4LowerLimit: 9500,
      class4UpperLimit: 50000,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
      defaultRate: 0.09,
  ...
  '2019/20': {
    childBenefitRates: {
      firstChildRate: 20.7,
      additionalChildRate: 13.7,
    },
    hicbc: { threshold: 50000, taperDivisor: 100 },
    qualifyingEarnings: { lower: 6136, upper: 50000 },
    pensionAnnualAllowance: {
      standard: 40000,
      taperThresholdIncome: 110000,
      taperAdjustedIncome: 150000,
      minimum: 10000,
    },
    dividends: { allowance: 2000, rates: [0.075, 0.325, 0.381] },
    taxAllowance: {
    ...
    selfEmployedNI: {
      class2WeeklyRate: 3.0,
      class2SmallProfitsThreshold: 6365,
      class4LowerLimit: 8632,
      class4UpperLimit: 50000,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
  ...
  '2018/19': {
    ...
    selfEmployedNI: {
      class2WeeklyRate: 2.95,
      class2SmallProfitsThreshold: 6205,
      class4LowerLimit: 8424,
      class4UpperLimit: 46350,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
      defaultRate: 0.09,
  ...
  '2017/18': {
    ...
    selfEmployedNI: {
      class2WeeklyRate: 2.85,
      class2SmallProfitsThreshold: 6025,
      class4LowerLimit: 8164,
      class4UpperLimit: 45000,
      class4Rates: [0.09, 0.02],
    },
    studentLoan: {
      defaultRate: 0.09,
