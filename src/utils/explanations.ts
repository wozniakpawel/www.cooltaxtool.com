const explanations: Record<string, { title: string; content: string }> = {
  ...
  autoEnrolmentAsSalarySacrifice: {
    ...
    content:
      'When enabled, your auto enrolment contributions are treated as salary sacrifice. This means they are deducted from your gross pay before tax and National Insurance are calculated, saving you NI contributions compared to net pay. When disabled, this field models a net-pay workplace pension. Use personal payments for relief-at-source contributions.',
  },
  salarySacrifice: {
  ...
  taxReliefAtSource: {
    ...
    content:
      'Relief at source is a method of providing tax relief on personal pension contributions. Under this system, your pension provider claims basic rate tax relief (currently 20%) from HMRC on your behalf and adds it to your pension pot. For example, if you contribute £80, the provider claims £20 from HMRC, making the gross contribution £100. Higher and additional rate taxpayers can claim further relief through self-assessment. Relief is limited to the higher of £3,600 gross or relevant UK earnings. Earnings below the Personal Allowance can still support full relief up to that earnings limit.',
  },
  annualGrossSalary: {
  ...
  annualGrossDividends: {
    ...
    content:
      "Dividend income from shares, before any tax. Dividends are taxed after your other income, at dividend rates (10.75% / 35.75% / 39.35% in 2026/27) with a tax-free dividend allowance (£500 for 2024/25 onwards). There is no National Insurance on dividends, and Scottish residents pay the UK-wide dividend rates — Scottish income tax rates don't apply. Annual Self Assessment loan estimates include dividends when they exceed £2,000.",
  },
  workingDaysPerWeek: {
  ...
  result_incomeTax: {
    title: 'Income Tax',
    content:
      "Tax charged on your taxable income (gross income minus tax allowance and gross/net-pay pension deductions; relief-at-source payments instead extend tax bands). It is calculated in bands: each band has a rate applied only to income within that band's range. The breakdown shows how much of your income falls into each band and the tax charged on it.",
  },
  result_employeeNI: {
    title: 'Employee NI',
    content:
  ...
  result_takeHomePay: {
    title: 'Take Home Pay',
    content:
      'An annual cash estimate after eligible additional pension relief is claimed from HMRC, which may arrive separately from your payslip. Deductions include: Income Tax, Employee NI, Student Loan repayments, and pension contributions. This is your net pay — the money available to spend.',
  },
  result_pensionPot: {
    title: 'Pension Pot',
    content:
  ...
  result_childBenefits: {
    title: 'Child Benefits',
    content:
      'Gross Child Benefit you receive. Any High Income Child Benefit Charge (HICBC) is included separately in deductions. If the higher-income parent earns above the HICBC threshold, a percentage of the benefit is clawed back as a tax charge. Above a certain income, the full benefit is charged back, making the net benefit zero.',
  },
};
